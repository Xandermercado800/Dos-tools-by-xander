...
def main(proxy, url):
	...
	if proxy == None:
		while True:
			...
			req12 = r.get("https://raw.githubusercontent.com/Xandermercado800/Ggs/main/50k%20proxies.txt").text
			req = req1 + req2 + req3 + req4 + req5 + req6 + req7 + req8 + req9 + req10 + req11 + req12
			array = req.split()
